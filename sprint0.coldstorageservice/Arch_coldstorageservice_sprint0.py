...
with Diagram('coldstorageservice_sprint0Arch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
     ...
     with Cluster('ctx_coldstorage', graph_attr=nodeattr):
          testtruck=Custom('testtruck','./qakicons/symActorSmall.png')
     ...
     testtruck >> Edge( xlabel='accessguicmd', **eventedgeattr, fontcolor='red') >> sys
     ...
     serviceaccessgui >> Edge(color='blue', style='solid', xlabel='test_gotticket', fontcolor='blue') >> testtruck
