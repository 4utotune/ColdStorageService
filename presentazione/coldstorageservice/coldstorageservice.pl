...
context(ctx_coldstorage, "localhost",  "TCP", "11802").
 qactor( basicrobot, ctxbasicrobot, "external").
  qactor( sonarreceiver, ctx_coldstorage, "kt.SonarMQTTReceiver").
  qactor( distancefilter, ctx_coldstorage, "kt.DistanceFilter").
  qactor( ledmqttsender, ctx_coldstorage, "kt.ledMQTTSender").
