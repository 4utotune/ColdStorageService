...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     accessgui_proxy >> Edge(color='magenta', style='solid', decorate='true', label='<proxy_storerequest &nbsp; proxy_insertticket &nbsp; >',  fontcolor='magenta') >> coldstorageservice
     coldstorageservice >> Edge(color='blue', style='solid',  label='<gotoindoor &nbsp; >',  fontcolor='blue') >> transporttrolley
     coldstorageservice >> Edge(color='blue', style='solid',  label='<coapUpdate &nbsp; chargetaken &nbsp; >',  fontcolor='blue') >> accessgui_proxy
     ...
     transporttrolley >> Edge(color='blue', style='solid',  label='<coapUpdate &nbsp; >',  fontcolor='blue') >> statusgui_proxy
     coldstorageservice >> Edge(color='blue', style='solid',  label='<coapUpdate &nbsp; >',  fontcolor='blue') >> statusgui_proxy
     transporttrolley >> Edge(color='blue', style='solid',  label='<chargetaken &nbsp; >',  fontcolor='blue') >> coldstorageservice
     basicrobot >> Edge(color='blue', style='solid',  label='<coapUpdate &nbsp; >',  fontcolor='blue') >> statusgui_proxy
diag
