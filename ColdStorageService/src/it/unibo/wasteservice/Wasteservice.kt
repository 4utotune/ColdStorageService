		...
		return { //this:ActionBasciFsm
				state("state_init") { //this:State
					action { //it:State
						...
						CommUtils.outblack("[WasteService] Reset:")
						CommUtils.outblack("	Plastic: $CurrentPlastic / ${wasteservice.Constants.MAXPB} KG")
						CommUtils.outblack("	Glass: $CurrentGlass / ${wasteservice.Constants.MAXGB} KG")
				...
				state("state_idle") { //this:State
					action { //it:State
						CommUtils.outblack("[WasteService] Idle...")
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
					sysaction { //it:State
